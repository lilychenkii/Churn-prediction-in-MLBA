...
CREATE TABLE `review` (
  ...
  KEY `fk_review_order_idx` (`orderid`),
  KEY `fk_review_restaurant_idx` (`restaurantid`),
  KEY `fk_review_customer_idx` (`customerid`),
  CONSTRAINT `fk_review_customer` FOREIGN KEY (`customerid`) REFERENCES `customer` (`customerid`) ON DELETE CASCADE ON UPDATE CASCADE,
